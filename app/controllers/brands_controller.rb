class BrandsController < ApplicationController
  before_action :load_brand, only: [:destroy, :edit, :update]
  ...
  def destroy
    if @brand.products.any?
      flash[:danger] = t "brands.deleting_warning"
    elsif @brand.destroy
      flash[:success] = t "brands.deleted"
    else
      flash[:danger] = t "brands.delete_fail"
    end
    redirect_to brands_path
  end
